    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            if (error.code === 'auth/popup-blocked') {
                showToast("Brauzer popupni blokladi. Iltimos, ruxsat bering va qaytadan urinib ko'ring.", 'warning');
            } else if (error.code === 'auth/popup-closed-by-user') {
                showToast("Login oynasi yopildi.", 'info');
            } else {
                showToast(error.message || "Google orqali kirishda xatolik yuz berdi.", 'error');
            }
        } finally {
            setLoading(false);
        }
                ...
                <div className="bg-white rounded-[2rem] overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="px-8 pb-8">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full py-4 bg-white border-2 border-gray-100 text-gray-700 rounded-2xl font-bold text-lg flex items-center justify-center gap-3 hover:bg-gray-50 transition-all duration-300 disabled:opacity-50 shadow-lg shadow-indigo-100/50 hover:shadow-xl hover:shadow-indigo-200/50 group active:scale-[0.98]"
                        >
